  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        tip: "Book a taxi for the North–South transfer in advance. Your EzyGoa driver can pick you up from your North Goa hotel and drop you at your South Goa resort — luggage and all, no extra stops needed.",
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          "Mopa Airport → Panjim: Dzire ₹900 | Ertiga ₹1,200 | Innova ₹1,600",
          "Mopa Airport → Anjuna/Vagator: Dzire ₹1,400 | Ertiga ₹1,700 | Innova ₹2,300",
          "Dabolim Airport → Calangute: Dzire ₹1,500 | Ertiga ₹1,800 | Innova ₹2,200",
          "Dabolim Airport → Panjim: Dzire ₹900 | Ertiga ₹1,200 | Innova ₹1,600",
          "Dabolim Airport → Margao: Dzire ₹500 | Ertiga ₹650 | Innova ₹900",
        ],
